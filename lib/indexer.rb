...
module Indexer
    ...
    def delete_document(id)
      ...
      commit_success = commit_to_solr(solr)
      @@log.error("Attempting to commit after deleted the document with an id of #{id} failed.  The specifc error returned should be logged above this.") unless commit_success
      commit_success
    end
