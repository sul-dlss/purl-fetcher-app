class DocsController < ApplicationController
  ...
  #Stub function that returns okay when index is calld.  Under the current spec, this should never be called.
  #
  #@return [String] The word okay
  def index
    render_result("ok")
  end
  ...
  #This is reachable via calling just /docs, currently we have no behavior associated with doing this so I just display a message letting the user know this
  #
  #@return [String] A message informing you to call /docs/changes or /docs/changes instead
  def show
