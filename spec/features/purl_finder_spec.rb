  ...
  describe('Indexing/finding') do
    ...
    describe('deleting documents') do
      ...
      it 'saves a druid, then marks the druid as deleted, then resaves it correctly' do
        ...
        expect(index_end_time > purl.published_at).to be_truthy # the index time should be between the start and end time
        expect(index_start_time < purl.published_at).to be_truthy # the index time should be between the start and end time
